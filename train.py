...
TOKENIZERS_PARALLELISM=false python train_pubmedbert_mesh_tl_v9.py \\
    ...
    --train_path         /localscratch/Users/ratri/Bert/splits/neurology/train.json \\
    --val_path           /localscratch/Users/ratri/Bert/splits/neurology/val.json \\
    --abstract_mesh_path /localscratch/Users/ratri/Bert/kg/neurology/splits/train_abstract_mesh.csv \\
    --nodes_csv_path     /localscratch/Users/ratri/Bert/kg/neurology/nodes.csv \\
    --unseen_codes_path  /localscratch/Users/ratri/Bert/splits/neurology/unseen_codes.json \\
    --output_dir         /localscratch/Users/ratri/Bert/runs/neurology_tl_v9 \\
    --label_mode unique_id --epochs 20 --warmup_epochs 5 --batch_size 32 \\
    --lr 1e-3 --top_k 0 --fp16

TOKENIZERS_PARALLELISM=false python train_pubmedbert_mesh_tl_v9.py \\
    --mode test --experiment supervised --domain neurology \\
    --test_path  /localscratch/Users/ratri/Bert/splits/neurology/test_supervised.json \\
    --output_dir /localscratch/Users/ratri/Bert/runs/neurology_tl_v9

# ── IMMUNOLOGY ─────────────────────────────────────────────────────────
TOKENIZERS_PARALLELISM=false python train_pubmedbert_mesh_tl_v9.py \\
    --mode train --experiment supervised --domain immunology \\
    --train_path         /localscratch/Users/ratri/Bert/splits/immunology/train.json \\
    --val_path           /localscratch/Users/ratri/Bert/splits/immunology/val.json \\
    --abstract_mesh_path /localscratch/Users/ratri/Bert/kg/immunology/splits/train_abstract_mesh.csv \\
    --nodes_csv_path     /localscratch/Users/ratri/Bert/kg/immunology/nodes.csv \\
    --unseen_codes_path  /localscratch/Users/ratri/Bert/splits/immunology/unseen_codes.json \\
    --output_dir         /localscratch/Users/ratri/Bert/runs/immunology_tl_v9 \\
    --label_mode unique_id --epochs 20 --warmup_epochs 5 --batch_size 32 \\
    --lr 1e-3 --top_k 0 --fp16

TOKENIZERS_PARALLELISM=false python train_pubmedbert_mesh_tl_v9.py \\
    --mode test --experiment supervised --domain immunology \\
    --test_path  /localscratch/Users/ratri/Bert/splits/immunology/test_supervised.json \\
    --output_dir /localscratch/Users/ratri/Bert/runs/immunology_tl_v9

# ── EMBRYOLOGY ─────────────────────────────────────────────────────────
TOKENIZERS_PARALLELISM=false python train_pubmedbert_mesh_tl_v9.py \\
    --mode train --experiment supervised --domain embryology \\
    --train_path         /localscratch/Users/ratri/Bert/splits/embryology/train.json \\
    --val_path           /localscratch/Users/ratri/Bert/splits/embryology/val.json \\
    --abstract_mesh_path /localscratch/Users/ratri/Bert/kg/embryology/splits/train_abstract_mesh.csv \\
    --nodes_csv_path     /localscratch/Users/ratri/Bert/kg/embryology/nodes.csv \\
    --unseen_codes_path  /localscratch/Users/ratri/Bert/splits/embryology/unseen_codes.json \\
    --output_dir         /localscratch/Users/ratri/Bert/runs/embryology_tl_v9 \\
    --label_mode unique_id --epochs 20 --warmup_epochs 5 --batch_size 32 \\
    --lr 1e-3 --top_k 12 --fp16

TOKENIZERS_PARALLELISM=false python train_pubmedbert_mesh_tl_v9.py \\
    --mode test --experiment supervised --domain embryology \\
    --test_path  /localscratch/Users/ratri/Bert/splits/embryology/test_supervised.json \\
    --output_dir /localscratch/Users/ratri/Bert/runs/embryology_tl_v9

# ── TAIL-LABEL (run after supervised; uses test_tail.json + tail_label_ids.json) ──
TOKENIZERS_PARALLELISM=false python train_pubmedbert_mesh_tl_v9.py \\
    --mode test --experiment tail --domain neurology \\
    --test_path            /localscratch/Users/ratri/Bert/splits/neurology/test_tail.json \\
    --tail_label_ids_path  /localscratch/Users/ratri/Bert/splits/neurology/tail_label_ids.json \\
    --tail_mask_head_labels \\
    --output_dir /localscratch/Users/ratri/Bert/runs/neurology_tl_v9

TOKENIZERS_PARALLELISM=false python train_pubmedbert_mesh_tl_v9.py \\
    --mode test --experiment tail --domain immunology \\
    --test_path            /localscratch/Users/ratri/Bert/splits/immunology/test_tail.json \\
    --tail_label_ids_path  /localscratch/Users/ratri/Bert/splits/immunology/tail_label_ids.json \\
    --tail_mask_head_labels \\
    --output_dir /localscratch/Users/ratri/Bert/runs/immunology_tl_v9

TOKENIZERS_PARALLELISM=false python train_pubmedbert_mesh_tl_v9.py \\
    --mode test --experiment tail --domain embryology \\
    --test_path            /localscratch/Users/ratri/Bert/splits/embryology/test_tail.json \\
    --tail_label_ids_path  /localscratch/Users/ratri/Bert/splits/embryology/tail_label_ids.json \\
    --tail_mask_head_labels \\
    --output_dir /localscratch/Users/ratri/Bert/runs/embryology_tl_v9
